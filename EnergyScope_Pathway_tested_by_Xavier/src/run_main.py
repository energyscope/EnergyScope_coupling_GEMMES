    ...
    for m in range(len(N_year_opti)):
        ...
        if run_opti:
            ...
            # TO DO AT EVERY STEP OF THE TRANSITION
                ...
                ampl.set_params('gwp_limit',{('YEAR_2015'):450000})
                ampl.set_params('gwp_limit',{('YEAR_2020'):331472}) #121250 133715
                ampl.set_params('gwp_limit',{('YEAR_2025'):277780}) #101610 111430
                ampl.set_params('gwp_limit',{('YEAR_2030'):224086})  #81969 89145
                ampl.set_params('gwp_limit',{('YEAR_2035'):170392}) #62328 66860
                ampl.set_params('gwp_limit',{('YEAR_2040'):116700}) #42688 44575
                ampl.set_params('gwp_limit',{('YEAR_2045'):63006}) #23047 22290
                ampl.set_params('gwp_limit',{('YEAR_2050'):9314})
