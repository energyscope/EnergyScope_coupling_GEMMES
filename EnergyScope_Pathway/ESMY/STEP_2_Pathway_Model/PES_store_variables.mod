...
var F_new_up_to {PHASE_UP_TO union {"2015_2020"}, TECHNOLOGIES} >= 0; #[GW/GWh] Accounts for the additional new capacity installed in a new phase from the start of the optimisation (2020)
...
var F_decom_up_to {PHASE_UP_TO,PHASE_UP_TO union {"2015_2020"}, TECHNOLOGIES} >= 0; #[GW] Accounts for the decommissioned capacity in a new phase from the start of the optimisation (2020)
