...
- second release, with python wrapper and some equations tailored to the case of Colombia and Turkey (v2.2 Energy system update): 'EnergyScope TD' folder in https://github.com/energyscope/EnergyScope_coupling_GEMMES
